...
username_friends = ['mizlyana88', 'marcomichett', '_therealv_', '_alessandraperrone__', 'stephilouw', 'hilowell', 'la_yanii', 'mala_tica02', 'emii_bby', 'laura_nesakysiu', 'serosiii', 'luc.vaclavikova', 'h_m_r22', 'zoooeb', 'barbarafontanive', 'karimjemaparis', 'axellecbd_b', 'shadowhopee', 'hern.bustamante','carolina.insta', 'pragneshghoda_', 'schiaviii', 'claudidominguez']

for i in username_friends:
	...
	with open("friends_"+i+".txt", "w") as text_file:
